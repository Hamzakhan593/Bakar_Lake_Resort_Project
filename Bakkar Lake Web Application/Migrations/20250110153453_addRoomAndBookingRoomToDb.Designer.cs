...
namespace Bakkar_Lake_Web_Application.Migrations
{
    ...
    [Migration("20250110153453_addRoomAndBookingRoomToDb")]
    partial class addRoomAndBookingRoomToDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bakkar_Lake_Web_Application.Models.BookingRoom", b =>
                {
                    ...
                    b.HasKey("B_Id", "RoomId");

                    b.HasIndex("RoomId");

                    b.ToTable("BookinRooms");
                });
            ...
            modelBuilder.Entity("Bakkar_Lake_Web_Application.Models.BookingRoom", b =>
                {
                    ...
                    b.HasOne("Bakkar_Lake_Web_Application.Models.Room", "Room")
                        .WithMany("BookingRooms")
